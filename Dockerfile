...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-turnos"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-turnos"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-turnos \
    KIRLET_TECHNICAL_ID=subject-turnos \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
